...
# below is used to create database from above
...
class NewBlogPost(FlaskForm):
    ...
    img_url = StringField('Blog Img_url', validators=[DataRequired(), URL()])
...
def edit_post(post_id):
    ...
    return render_template('make-post.html', form=edit_form,value=post_id)
